 ...
 */
/*
 liveagent.init('https://d.la1w1.salesforceliveagent.com/chat', '572U000000001XO', '00DU0000000Jga6');
*/
...
/* ============================================  
  ...
  //PS4 Headsets
  var ps4Headsets = [
    elite800, stealth500p, stealth400, recon60p, recon50p, elitePro, tac, px24, p4c, p12, px4, sandtrooper, xWing, ps4upgrade
    ];
  ...
  var otherPs4 = [
    ...
    //Xbox One Headsets
  var x1Headsets = [
    elite800x, stealth420x, xo7Pro, xo4Stealth, elitePro, tac, px24, xoOne, recon50x, recon30x, sandtrooper, xWing, taa, hac, hacPlus
    ];
  ...
  //PC Headsets
  var pcHeadsets = [
    stealth450, recon50, z22, z60, recon320, tac, starWars, heroes, zLa, z11, z300, px24, x12,i60, i30, grip500, gripArena, amigo2, micro2
    ];
